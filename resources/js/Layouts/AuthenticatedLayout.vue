...
<template>
    ...
    <div class="bg-gray-100 h-full min-w-[1150px]">
        ...
        >
            ...
            <Link
               v-if="$page.props.auth.user"   :href="route('address.index')"
                >
                ...
                >
                    ...
                    >
                        <div v-if="accountAndList">
                            <div
                               v-if="$page.props.auth.user" class="flex items-center justify-between py-2.5 border-b"
                            >
                        ...
                        <div v-if="!$page.props.auth.user" class="p-4 text-center">
        ...
        <main class="max-w-[1500px] bg-white mx-auto">
            <div class="pt-[98px]"></div>
            <slot />
        </main>
        <div class="w-full bg-white mb-0 overflow-x-scroll">
    ...
    <div class="top-0 z-50 fixed w-full bg-black bg-opacity-10">
    <div
        v-if="showMenu"
