                ...
                <div class="border border-gray-300 rounded-lg">
                    <div class="my-2 mx-3 mb-2">
                        <div class="flex items-center justify-center border-b border-gray-300 pb-1">
                            ...
                            >
                                <MapMarkerOutlineIcon :size="17" /> Delivery to {{$page.props.auth.user.first_name}} <span v-if=" $page.props.auth.address" class="pl-2"> {{$page.props.auth.address.city}}</span>
                            </Link>
                            <Link
                                v-else
                                :href="route('login')"
